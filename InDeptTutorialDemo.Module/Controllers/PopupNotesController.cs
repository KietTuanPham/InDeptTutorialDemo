...
namespace InDeptTutorialDemo.Module.Controllers
{
    ...
    public partial class PopupNotesController : ViewController
    {
        ...
        private void ShowNoteAction_CustomizePopupWindowParams(object sender, CustomizePopupWindowParamsEventArgs e)
        {
        ...
        private void ShowNoteAction_Execute(object sender, PopupWindowShowActionExecuteEventArgs e)
        {
